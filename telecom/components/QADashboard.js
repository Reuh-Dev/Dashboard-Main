...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الاتصالات.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Telecommunications Services QA Dashboard',
    ...
    zipFilename: 'telecom_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'tel_services_corrected.json', 'application/json;charset=utf-8');
  }
