...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الثقافة.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Culture Services QA Dashboard',
    ...
    zipFilename: 'culture_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'cul_services_corrected.json', 'application/json;charset=utf-8');
  }
