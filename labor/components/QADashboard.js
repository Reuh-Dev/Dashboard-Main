...
const COPY = {
  ...
  en: {
    ...
    zipFilename: 'labor_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'lab_services_corrected.json', 'application/json;charset=utf-8');
  }
