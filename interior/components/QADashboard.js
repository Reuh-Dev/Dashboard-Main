...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الداخلية.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Interior Services QA Dashboard',
    ...
    zipFilename: 'interior_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'int_services_corrected.json', 'application/json;charset=utf-8');
  }
