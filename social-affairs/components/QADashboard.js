...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الشؤون_الاجتماعية.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Social Affairs Services QA Dashboard',
    ...
    zipFilename: 'social_affairs_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'soc_services_corrected.json', 'application/json;charset=utf-8');
  }
