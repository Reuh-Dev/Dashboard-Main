...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الدفاع.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'National Defense Services QA Dashboard',
    ...
    zipFilename: 'defense_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'def_services_corrected.json', 'application/json;charset=utf-8');
  }
