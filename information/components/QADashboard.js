...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الإعلام.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Information Services QA Dashboard',
    ...
    zipFilename: 'information_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'inf_services_corrected.json', 'application/json;charset=utf-8');
  }
