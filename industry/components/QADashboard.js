...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الصناعة.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Industry Services QA Dashboard',
    ...
    zipFilename: 'industry_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'ind_services_corrected.json', 'application/json;charset=utf-8');
  }
