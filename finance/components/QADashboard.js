...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_المالية.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Finance Services QA Dashboard',
    ...
    zipFilename: 'finance_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'fin_services_corrected.json', 'application/json;charset=utf-8');
  }
