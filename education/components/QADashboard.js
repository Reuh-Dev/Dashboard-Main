...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_التربية_والتعليم.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Education Services QA Dashboard',
    ...
    zipFilename: 'education_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'edu_services_corrected.json', 'application/json;charset=utf-8');
  }
