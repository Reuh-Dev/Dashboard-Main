...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_المهجرين.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Displaced Citizens Services QA Dashboard',
    ...
    zipFilename: 'displaced_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'dis_services_corrected.json', 'application/json;charset=utf-8');
  }
