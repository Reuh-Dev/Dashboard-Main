...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الطاقة_والمياه.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Energy and Water Services QA Dashboard',
    ...
    zipFilename: 'energy_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'enr_services_corrected.json', 'application/json;charset=utf-8');
  }
