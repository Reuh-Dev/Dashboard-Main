...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الخارجية.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Foreign Affairs Services QA Dashboard',
    ...
    zipFilename: 'foreign_affairs_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'for_services_corrected.json', 'application/json;charset=utf-8');
  }
