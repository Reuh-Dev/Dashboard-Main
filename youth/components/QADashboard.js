...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الشباب_والرياضة.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Youth and Sports Services QA Dashboard',
    ...
    zipFilename: 'youth_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'yth_services_corrected.json', 'application/json;charset=utf-8');
  }
