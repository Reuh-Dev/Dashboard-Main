...
const COPY = {
  ...
  en: {
    ...
    zipFilename: 'justice_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'jus_services_corrected.json', 'application/json;charset=utf-8');
  }
