...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الصحة.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Public Health Services QA Dashboard',
    ...
    zipFilename: 'health_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'hlt_services_corrected.json', 'application/json;charset=utf-8');
  }
