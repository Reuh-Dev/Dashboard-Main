...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_الأشغال.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Public Works Services QA Dashboard',
    ...
    zipFilename: 'public_works_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'pwt_services_corrected.json', 'application/json;charset=utf-8');
  }
