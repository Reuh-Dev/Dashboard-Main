...
const COPY = {
  ar: {
    ...
    zipFilename: 'مرفقات_البيئة.zip',
    status: { validated: 'محفوظ', no: 'لا', pending: 'قيد المراجعة', cancelled: 'ملغى' }
  },
  en: {
    switchToArabic: 'AR',
    switchToEnglish: 'EN',
    title: 'Environment Services QA Dashboard',
    ...
    zipFilename: 'environment_attachments.zip',
...
export default function QADashboard({ records }) {
  ...
  function exportCorrectedJSON() {
    ...
    downloadBlob(JSON.stringify(cleanRecords, null, 2), 'env_services_corrected.json', 'application/json;charset=utf-8');
  }
